...
//		{
//			UpdateEnvironmentQuality ();
//			CameraImageEffectUpdate.updateEffects = true;	
//		}
//	}

	public void UpdateEnvironmentQuality()
	{
//		print ("Updating Graphics");
		...
		int currentMeshQuality =  PlayerPrefs.GetInt ("MeshQuality");

		//There's a glitch where fps drops to 2 when mesh quality is 2
		if(currentMeshQuality >= 2)
		{
			currentMeshQuality = 1;
		}
		QualitySettings.maximumLODLevel = currentMeshQuality;
