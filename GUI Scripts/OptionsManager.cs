...
public class OptionsManager : MonoBehaviour 
{
	...
	private int defaultDamageText = 1; //1 = true, 0 = false
	...
	//Invert X
	private int defaultInvertX = 0; //1 = true, 0 = false
	public Toggle invertXToggle;

	//Invert Y
	private int defaultInvertY = 0; //1 = true, 0 = false
	public Toggle invertYToggle;

	//Swap Mouse Butttons
	private int defaultSwapMouseButton = 0; // 1 = true, 0 = false
	public Toggle mouseSwapToggle;

	//Mouse Sensitivity 
	private float defaultMouseSensitivity = 5f;
	public Scrollbar mouseSensitivityScrollbar;

	//Mouse Smooth X
	private float defaultMouseSmoothX = 0.05f;
	public Scrollbar mouseSmoothXScrollbar;

	//Mouse Smooth Y
	private float defaultMouseSmoothY = 0.1f;
	 ...
	 * 9. Mode7point1
	*/
	private int defaultSpeakerMode = 1;
	...
	//Mouse Cursor Size
	private float defaultMouseCursorSize = 0.5f;
	...
	//Motion Blur
	private float defaultMotionBlur = 0.2f;
	public Scrollbar motionBlurScrollbar;

	//Bloom
	private float defaultBloom = 0.25f;
	public Scrollbar bloomScrollbar;

	//Sun Shafts
	private float defaultSunShaft = 0.22f;
